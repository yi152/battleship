...
# 			   The program generates 2 non-overlapping ships in random locations in the "ocean": a 1 x 3
# 			     ship and a 2 x 1 ship.
# 			   The program keeps the scores of the 2 players and determines the winner when all ships are
# 			     sunk or when the maximum number of turns (12) are reached.
